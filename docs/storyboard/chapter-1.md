...
| `research_depth: deep` | `/srv/engineering/chen-handoff/notes.txt` | Extended version: Jin Chen's notes include an extra item: "3. Ask what happened to ClearView Analytics" |
...
| `work_read_onboarding` | Read the onboarding docs | `cat ~/Documents/onboarding.md` | Exploring the work filesystem |
| `work_explore_team` | Learn about the team | `cat ~/Documents/team-info.md` | Context on NexaCorp's vagueness |
...
The big thing: you're replacing Jin Chen, our previous AI engineer.
...
2. **"What happened to Jin Chen?"** — Fires `objective_completed: asked_about_chen`.
...
I noticed you were looking at some of Jin Chen's old files. Just
...
**Trigger**: `after_file_read` — `/srv/engineering/chen-handoff/notes.txt`
...
**Trigger**: `after_objective` — `work_explore_team` (reading team-info.md)
...
Our Team:
  See team-info.md for the full roster.
...
#### `/home/{username}/Documents/team-info.md` (expanded)
...
| `work_read_onboarding` | Read the onboarding docs | `file_read` | `cat ~/Documents/onboarding.md` | Yes (story) |
| `work_explore_team` | Learn about the team | `file_read` | `cat ~/Documents/team-info.md` | No (suggested) |
