...
NexaCorp is a Series-A B2B SaaS company built around Chip, a full-stack AI platform with deep integration, and broad service-account permissions. 15 employees serving healthcare and finance customers.
